...
keys.desktopbuttons = gears.table.join(
   ...
   awful.button({ }, 2, function () nexttheme() end),
   awful.button({ }, 3, function () awful.util.spawn(apps.launcher_huge_center) end),
...
keys.globalkeys = gears.table.join(
   ...
   awful.key({modkey}, "r",
      function()
         awful.spawn(apps.launcher_center)
      end,
	...
	awful.key({modkey}, "d",
      function()
         awful.spawn(apps.launcher_medium_center)
      end,
      {description = "application launcher", group = "launcher"}
   ),
	...
	awful.key({modkey}, "v",
      function()
		 awful.spawn(apps.launcher_big_center)
      end,
      {description = "application launcher", group = "launcher"}
   ),
	...
	awful.key({modkey}, "g",
      function()
         awful.spawn(apps.launcher_huge_center)
      end,
      {description = "application launcher", group = "launcher"}
   ),
   ...
   awful.key({}, "Print",
	...
	awful.key({modkey}, "Print",
      function()
         awful.spawn.with_shell(apps.screenshot_seldraw, false)
      end
   ),
